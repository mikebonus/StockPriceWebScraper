...
class LosersActivity : AppCompatActivity() {
    ...
    private fun retrieveWebInfo(){
        ...
        thread {
            ...
            val date = doc.getElementsByClass("wsod_StockTimestamp").text() + " (Losers)"
            val goldTable = doc.getElementsByClass("wsod_dataTable wsod_dataTableBigAlt")

            // ii) Exact-Locating :
            val headers1 = goldTable[2]
                .getElementsByTag("tbody")[0]
                .getElementsByTag("tr")[1]
                .getElementsByTag("td")
            1
            val headers2 = goldTable[2]
                .getElementsByTag("tbody")[0]
                .getElementsByTag("tr")[2]
                .getElementsByTag("td")

            val headers3 = goldTable[2]
                .getElementsByTag("tbody")[0]
                .getElementsByTag("tr")[3]
                .getElementsByTag("td")

            val headers4 = goldTable[2]
                .getElementsByTag("tbody")[0]
                .getElementsByTag("tr")[4]
                .getElementsByTag("td")

            val headers5 = goldTable[2]
                .getElementsByTag("tbody")[0]
                .getElementsByTag("tr")[5]
                .getElementsByTag("td")

            val headers6 = goldTable[2]
                .getElementsByTag("tbody")[0]
                .getElementsByTag("tr")[6]
                .getElementsByTag("td")

            val headers7 = goldTable[2]
                .getElementsByTag("tbody")[0]
                .getElementsByTag("tr")[7]
                .getElementsByTag("td")

            val headers8 = goldTable[2]
                .getElementsByTag("tbody")[0]
                .getElementsByTag("tr")[8]
                .getElementsByTag("td")

            val headers9 = goldTable[2]
                .getElementsByTag("tbody")[0]
                .getElementsByTag("tr")[9]
                .getElementsByTag("td")

            val headers10 = goldTable[2]
                .getElementsByTag("tbody")[0]
...
//                // i) Set-up for retrieving data
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        inflater.inflate(R.menu.toolbar_menu_loserside, menu)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.btn_activer -> {
                val intent = Intent(this@LosersActivity, MainActivity::class.java)
                startActivity(intent)
            }

            R.id.btn_gainer -> {
                val intent = Intent(this@LosersActivity, GainersActivity::class.java)
                startActivity(intent)
            }
        }
